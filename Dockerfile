...
ENV JULIA_DEPOT_PATH /usr/local/julia/share/julia
...
# i386
	...
	\
 # add JuMP and OSS solvers
 julia -e """using Pkg; Pkg.add(\"JuMP\"); Pkg.add(\"GLPK\"); Pkg.add(\"Cbc\"); Pkg.add(\"Clp\")"""; \
 \
 julia -e """using JuMP, GLPK, Cbc, Clp"""; \
 \
# smoke test
	julia --version
